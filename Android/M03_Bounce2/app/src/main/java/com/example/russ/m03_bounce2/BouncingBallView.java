...
public class BouncingBallView extends View implements SensorEventListener {
    ...
    private ArrayList<Square> squares = new ArrayList<Square>(); // list of Balls
    ...
    public BouncingBallView(Context context) {
        ...
        //Create colors to pass as random colors.
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Square s : squares){
            ...
            if(s.collisionCheck(s)){
                s.count+=1;
                Log.w("ScoreLog", "Collision incremented, is now:" + s.count);
            }
            for (Ball b : balls) {
