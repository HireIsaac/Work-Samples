...
public abstract class vehicle extends Thread {
	...
	public vehicle() {
		...
		this.setInitX(rand.nextInt(((screenW-marginScreen) - marginScreen) + 1) + marginScreen);
		this.setInitY(rand.nextInt(((-1 * marginScreen) - ((-1 * screenH) - (-1 * marginScreen))) + 1) + (-1 * screenH) - (-1 * marginScreen));
	}
